...
import    { DateTimeResolver } from 'graphql-scalars';
    export const resolvers: Resolvers = {
      Query: { dbStatus: Query_dbStatus,game: Query_game,games: Query_games,hello: Query_hello,me: Query_me,myGames: Query_myGames,user: Query_user,userByEmail: Query_userByEmail,userByFirebaseId: Query_userByFirebaseId,userByPhoneNumber: Query_userByPhoneNumber,users: Query_users },
      Mutation: { addUserToGame: Mutation_addUserToGame,createGame: Mutation_createGame,createUser: Mutation_createUser,deleteGame: Mutation_deleteGame,deleteUser: Mutation_deleteUser,removeUserFromGame: Mutation_removeUserFromGame,updateGame: Mutation_updateGame,updateUser: Mutation_updateUser },
